...
var Constants = Ember.Object.create({
	...
	GOOGLE_TYPE_FILTER_CATEGORIES: [
		{type: "art_gallery", filterOption:"Art"},
		{type: "administrative_area_level_1", filterOption:"Destination"},
		{type: "administrative_area_level_2", filterOption:"Destination"},
		{type: "administrative_area_level_3", filterOption:"Destination"},
		{type: "administrative_area_level_4", filterOption:"Destination"},
		{type: "administrative_area_level_5", filterOption:"Destination"},
		{type: "colloquial_area", filterOption:"Destination"},
		{type: "country", filterOption:"Destination"},
		{type: "geocode", filterOption:"Destination"},
		{type: "intersection", filterOption:"Destination"},
		{type: "locality", filterOption:"Destination"},
		{type: "neighborhood", filterOption:"Destination"},
		{type: "political", filterOption:"Destination"},
		{type: "post_box", filterOption:"Destination"},
		{type: "postal_code", filterOption:"Destination"},
		{type: "postal_code_prefix", filterOption:"Destination"},
		{type: "postal_code_suffix", filterOption:"Destination"},
		{type: "postal_town", filterOption:"Destination"},
		{type: "route", filterOption:"Destination"},
		{type: "street_address", filterOption:"Destination"},
		{type: "street_number", filterOption:"Destination"},
		{type: "sublocality", filterOption:"Destination"},
		{type: "sublocality_level_1", filterOption:"Destination"},
		{type: "sublocality_level_2", filterOption:"Destination"},
		{type: "sublocality_level_3", filterOption:"Destination"},
		{type: "sublocality_level_4", filterOption:"Destination"},
		{type: "sublocality_level_5", filterOption:"Destination"},
		{type: "casino", filterOption:"Entertainment"},
		{type: "movie_theater", filterOption:"Entertainment"},
		{type: "stadium", filterOption:"Entertainment"},
		{type: "amusement_park", filterOption:"Family"},
		{type: "lodging", filterOption:"Hotels"},
		{type: "city_hall", filterOption:"Landmark"},
		{type: "library", filterOption:"Landmark"},
		{type: "local_government_office", filterOption:"Landmark"},
		{type: "beauty_salon", filterOption:"Lifestyle"},
		{type: "gym", filterOption:"Lifestyle"},
		{type: "spa", filterOption:"Lifestyle"},
		{type: "museum", filterOption:"Museum"},
		{type: "aquarium", filterOption:"Nature"},
		{type: "natural_feature", filterOption:"Nature"},
		{type: "park", filterOption:"Nature"},
		{type: "zoo", filterOption:"Nature"},
		{type: "bar", filterOption:"Nightlife"},
		{type: "night_club", filterOption:"Nightlife"},
		{type: "accounting", filterOption:"Other"},
		{type: "airport", filterOption:"Other"},
		{type: "atm", filterOption:"Other"},
		{type: "bank", filterOption:"Other"},
		{type: "bicycle_store", filterOption:"Other"},
		{type: "bowling_alley", filterOption:"Other"},
		{type: "bus_station", filterOption:"Other"},
		{type: "campground", filterOption:"Other"},
		{type: "car_dealer", filterOption:"Other"},
		{type: "car_rental", filterOption:"Other"},
		{type: "car_repair", filterOption:"Other"},
		{type: "car_wash", filterOption:"Other"},
		{type: "cemetery", filterOption:"Other"},
		{type: "courthouse", filterOption:"Other"},
		{type: "dentist", filterOption:"Other"},
		{type: "doctor", filterOption:"Other"},
		{type: "electrician", filterOption:"Other"},
		{type: "embassy", filterOption:"Other"},
		{type: "establishment", filterOption:"Other"},
		{type: "finance", filterOption:"Other"},
		{type: "fire_station", filterOption:"Other"},
		{type: "floor", filterOption:"Other"},
		{type: "food", filterOption:"Other"},
		{type: "funeral_home", filterOption:"Other"},
		{type: "gas_station", filterOption:"Other"},
		{type: "general_contractor", filterOption:"Other"},
		{type: "grocery_or_supermarket", filterOption:"Other"},
		{type: "hair_care", filterOption:"Other"},
		{type: "health", filterOption:"Other"},
		{type: "hospital", filterOption:"Other"},
		{type: "insurance_agency", filterOption:"Other"},
		{type: "laundry", filterOption:"Other"},
		{type: "lawyer", filterOption:"Other"},
		{type: "locksmith", filterOption:"Other"},
		{type: "meal_delivery", filterOption:"Other"},
		{type: "meal_takeaway", filterOption:"Other"},
		{type: "movie_rental", filterOption:"Other"},
		{type: "moving_company", filterOption:"Other"},
		{type: "painter", filterOption:"Other"},
		{type: "parking", filterOption:"Other"},
		{type: "pharmacy", filterOption:"Other"},
		{type: "physiotherapist", filterOption:"Other"},
		{type: "plumber", filterOption:"Other"},
		{type: "point_of_interest", filterOption:"Other"},
		{type: "police", filterOption:"Other"},
		{type: "post_office", filterOption:"Other"},
		{type: "premise", filterOption:"Other"},
		{type: "real_estate_agency", filterOption:"Other"},
		{type: "roofing_contractor", filterOption:"Other"},
		{type: "room", filterOption:"Other"},
		{type: "rv_park", filterOption:"Other"},
		{type: "school", filterOption:"Other"},
		{type: "storage", filterOption:"Other"},
		{type: "subpremise", filterOption:"Other"},
		{type: "subway_station", filterOption:"Other"},
		{type: "taxi_stand", filterOption:"Other"},
		{type: "train_station", filterOption:"Other"},
		{type: "transit_station", filterOption:"Other"},
		{type: "travel_agency", filterOption:"Other"},
		{type: "university", filterOption:"Other"},
		{type: "veterinary_care", filterOption:"Other"},
		{type: "church", filterOption:"Religious"},
		{type: "hindu_temple", filterOption:"Religious"},
		{type: "mosque", filterOption:"Religious"},
		{type: "place_of_worship", filterOption:"Religious"},
		{type: "synagogue", filterOption:"Religious"},
		{type: "bakery", filterOption:"Restaurants"},
		{type: "cafe", filterOption:"Restaurants"},
		{type: "restaurant", filterOption:"Restaurants"},
		{type: "book_store", filterOption:"Shopping"},
		{type: "clothing_store", filterOption:"Shopping"},
		{type: "convenience_store", filterOption:"Shopping"},
		{type: "department_store", filterOption:"Shopping"},
		{type: "electronics_store", filterOption:"Shopping"},
		{type: "florist", filterOption:"Shopping"},
		{type: "furniture_store", filterOption:"Shopping"},
		{type: "hardware_store", filterOption:"Shopping"},
		{type: "home_goods_store", filterOption:"Shopping"},
		{type: "jewelry_store", filterOption:"Shopping"},
		{type: "liquor_store", filterOption:"Shopping"},
		{type: "pet_store", filterOption:"Shopping"},
		{type: "shoe_store", filterOption:"Shopping"},
		{type: "shopping_mall", filterOption:"Shopping"},
		{type: "store", filterOption:"Shopping"}
	]
